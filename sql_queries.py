...
songplay_table_insert = ("INSERT INTO SONGPLAYS (songplay_id, start_time, user_id, level, song_id, artist_id, sessionId, location, userAgent) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s)")
...
artist_table_insert = ("INSERT INTO ARTISTS(artist_id, artist_name, location, latitude, longitude) values(%s,%s,%s,%s,%s) on conflict do nothing")
...
song_select = ("select s.song_id,a.artist_id from songs as s inner join artists as a on s.artist_id =a.artist_id \
